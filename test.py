...
class TestBinomialClass(unittest.TestCase):
    ...
    def test_binomial_pdf(self):
        self.assertEqual(round(self.binomial.binomial_pdf(5), 5), 0.07465)
        self.assertEqual(round(self.binomial.binomial_pdf(3), 5), 0.01235)
    
        self.binomial.replace_stats_with_data()
        self.assertEqual(round(self.binomial.binomial_pdf(5), 5), 0.05439)
        self.assertEqual(round(self.binomial.binomial_pdf(3), 5), 0.00472)
